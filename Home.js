...
class Greenwood extends React.Component {
  ...
  componentDidMount() {
    ...
    //alert("Component")
    CleverTap.createNotificationChannel("877965", "dev87796", "CT React Native Testing", 1, true);
    ...
    return (
      ...
      />
          ...
          <View style={{ width: 100, paddingTop: 30 }}>
            <Button title='Push Event ' color={this.state.color} onPress={() => this.pushEvent()} />
          </View>
          {/* <View style={{ width: 100, paddingTop: 30 }}>
            <Button title='Fetch Feature Flag 'color={this.state.color} onPress={() => this.fetchFeatureflag()} />
          </View> */}
          <View style={{ width: 100, paddingTop: 30 }}>
...
{ "is_test" : true , "targetId" : 1234 , "key_values" : { "key" : "value"} , "profiles" : [ { "Identity" : "UserId" , "Email" : "User@user.com" , "push_token" : "Token"} , { "Identity" : "UserId" , "Email" : "User@user.com" , "push_token" : "Token"} , { "Identity" : "UserId" , "Email" : "User@user.com" , "push_token" : "Token"} , { "Identity" : "UserId" , "Email" : "User@user.com" , "push_token" : "Token"} , { "Identity" : "UserId" , "Email" : "User@user.com" , "push_token" : "Token"}]}
